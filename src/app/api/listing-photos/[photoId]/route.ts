...
/**
 * Serves a listing photo — same pattern as /api/photos/[photoId] for
 * maintenance photos. Authorization runs on every request
 * (canViewListingPhoto): an unguessable id is not access control on its own,
 * and staff removed from an org must not keep reading its photos.
 *
