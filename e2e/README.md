...
Four Playwright scripts that drive a real browser against a running dev server.
...
| `npm run e2e:security` | cross-org isolation, signup/login abuse, role boundaries, open redirect | 11 |
